...
// Provisioner is a CRD Controller responsible for executing the Reconcile() function in
// response to OBC events.
type Controller struct {
	...
	// optional map of provisioner specific labels added to the obc, ob, secret, cm
